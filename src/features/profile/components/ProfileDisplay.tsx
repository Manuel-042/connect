...
//                 </Link>
//                 {!isLoggedInUser && <Button className={twMerge(buttonStyles(), "cursor-pointer font-bold text-sm bg-white text-gray-800 hover:bg-white")}>Follow</Button>}
//             </div>
    ...
    return (
        <div className="absolute z-50 top-6 px-3 py-4 shadow-sm dark:shadow-neutral-50 w-[250px] hidden lg:group-hover:block bg-black rounded-lg">
            ...
            <div className="flex flex-col items-start justify-center mb-3">
                ...
                <p className="dark:text-gray-500 text-sm">@{username}</p>
            </div>
            ...
            <div className="flex items-center justify-between">
                <Link to={`/${username}`}>
                    <p className="dark:text-gray-500 text-sm cursor-pointer hover:underline">
                        <span className="dark:text-neutral-300 font-bold">{formatCount(followingCount)}</span> Following
                    </p>
                </Link>
                <Link to={`/${username}`}>
                    <p className="dark:text-gray-500 text-sm cursor-pointer hover:underline">
                        <span className="dark:text-neutral-300 font-bold">{formatCount(followerCount)}</span> Followers
                    </p>
                </Link>
            </div>
        </div>
