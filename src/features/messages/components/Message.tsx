                    ...
                    <div>
                        <div className="flex items-center justify-start">
                            <div className="flex items-center justify-center gap-2 cursor-pointer">
                                <p className="font-bold dark:text-neutral-300 text-sm max-w-24 overflow-hidden">{appUser?.displayname}</p>
                                {appUser?.isVerified && <LuBadgeCheck className="text-primary" />}
                                <p className="dark:text-gray-500 text-sm max-w-16 truncate">@{appUser?.username}</p>
                            </div>
