  ...
  useEffect(() => {
    const rehydrateToken = async () => {
      try {
        ...
        toast.error("Failed to rehydrate token");
      } finally {
        setRehydrationAttempted(true);
      }
    };

    if (!token && !rehydrationAttempted) {
      console.log("Called rehydration logic twice now");
      rehydrateToken();
    }
      ...
      <div className="dark:bg-black">
        <div className="">
          <GifProvider>
            <Routes
              location={
                previousLocation ? { pathname: previousLocation } : location
              }
            >
              ...
              <Route element={<PersistLogin />}>
                <Route element={<ProtectedRoute />}>
                  <Route
                    path="/home"
                    element={<Layout rightComponent={HomeRightContent} />}
                  >
                  ...
                  <Route
                    path="/explore"
                    element={<Layout rightComponent={ExploreRightContent} />}
                  >
                  ...
                  <Route
                    ...
                    element={<Layout rightComponent={ConnectRightContent} />}
                  >
                  ...
                  <Route
                    path="i/trends"
                    element={<Layout rightComponent={TrendsRightContent} />}
                  >
                  ...
                  <Route
                    path="/notifications"
                    element={
                      <Layout rightComponent={NotificationRightContent} />
                    }
                  >
                  ...
                  <Route
                    path="/messages"
                    element={<Layout rightComponent={MessageRightContent} />}
                  >
                    <Route index element={<MessagePageContent />} />
                  </Route>

                  <Route
                    path="/messages/:user_id/:account_id"
                    element={<Layout rightComponent={MessageRightContent} />}
                  >
                    <Route index element={<MessagePageContent />} />
                  </Route>
                  ...
                  <Route
                    path="/:username"
                    element={<Layout rightComponent={ProfileRightContent} />}
                  >
                  ...
                  <Route
                    path="/i/bookmarks"
                    element={<Layout rightComponent={BookmarkRightContent} />}
                  >
                  ...
                  <Route
                    path="/search"
                    element={<Layout rightComponent={SearchRightContent} />}
                  >
                  ...
                  <Route
                    path="/settings"
                    element={<Layout rightComponent={SettingsRightContent} />}
                  >
            ...
            {previousLocation && (
              <Routes>
                ...
                <Route
                  path="/verify-code"
                  element={
                    <OTPVerification email={"ebukaezeanya14@gmail.com"} />
                  }
                />
                ...
                />
                <Route
                  path="/post/:postId/photo/:photoId"
                  element={<PostModal />}
                />
