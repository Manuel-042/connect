        ...
        <div className="flex flex-col items-center justify-center w-full min-h-screen p-2 relative">
            ...
            <div className="w-80 gap-8 flex flex-col justify-between items-center border-1 shadow-md dark:shadow-neutral-800 rounded-md px-5 py-6">
                <div className="text-center flex flex-col">
                    <FaEnvelopeOpenText className='self-center dark:text-neutral-300' font-size="30px"/>
                ...
                <OTPVerificationForm />
                <p className="text-xs dark:text-neutral-300">Didn't recieve an email? <Link to="/forgot" className="text-xs text-blue-700 hover:underline underline-offset-1">click to resend</Link></p>
