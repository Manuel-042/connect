...
const Logout = () => {
    ...
    return (
        <div className={`fixed top-0 z-50 overflow-hidden left-0 h-full w-full max-w-xs flex items-center justify-center transition-transform transform`} style={{ background: 'rgba(91, 112, 131, 0.7)' }}>

            <div className={`bg-black flex flex-col rounded-3xl items-center justify-center p-6 w-4/5`}>
                ...
                <div className="flex flex-col flex-1 w-full">
                    <Button className='dark:bg-white dark:text-black text-sm font-bold mb-2 py-3'>Log out</Button>
